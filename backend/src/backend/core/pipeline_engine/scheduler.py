...
from .models import Pipeline, PipelineNode, NodeStatus, ResourceAvailability, SchedulingContext
from backend.common.enums import NodeType
...
class PipelineScheduler:
    ...
    def _apply_resource_constraints(
        ...
        for node_id in nodes:
            ...
            if (resource_availability.cpu >= required_cpu and
                resource_availability.memory >= required_memory):
