...
from backend.common.job_models import PipelineJob, JobStatus, JobFactory, JobPriority
...
from backend.core.pipeline_engine.models import NodeType, Pipeline
...
class PipelineController(BaseController):
    ...
    async def instantiate_template(
        ...
        """
        from backend.core.pipeline_engine.builder import PipelineTemplate
